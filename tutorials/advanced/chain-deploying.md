...
for i in `seq 0 6`
do
  eris chains start --init-dir advchain/"advchain_validator_00$i" --machine "my-advchain-val-00$i" advchain
done
```
...
```bash
eris chains start --init-dir advchain/advchain_root_000 advchain
```
