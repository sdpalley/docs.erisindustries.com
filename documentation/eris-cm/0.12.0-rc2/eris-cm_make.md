...
* [eris-cm](https://docs.erisindustries.com/documentation/eris-cm/0.12.0-rc2/eris-cm/)	 - The Eris Chain Manager is a utility for performing complex operations on eris chains
